...
start:
	...
	outerloop:
		...
		sort:
			...
			ja noswap ; here we are comparing the 5 with 7 and if 5 will be greater then there will be no swap  other wise 5 will be stored in 
			cx register as a minimum for at the moment
